...
decoder_size = (
    decoder_card_offset + (1 + decoder_main_feature + SelectContext.RECOVER_SPECIAL_CONDITION) * card_count
...
def mcts_agent(obs_dict: dict, your_deck: list[int], model: MyModel) -> tuple[list[int], LearnSample]:
    ...
    search_state = search_begin(
        ...
        opponent_prize=[1]
        * len(state.players[1 - your_index].prize),  # Fill with Basic Energy (There is no deep meaning)
